...
from PyEvo.selection.fitness_proportional import FitnessProportionalSelection
...
class TestFitnessProportionalSelection(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fitness = [0.023255813953488372, 0.45930232558139533, 0.686046511627907, 0.8837209302325582, 0.0,
                        0.4418604651162791, 1.0, 0.7267441860465116, 0.27906976744186046, 0.23255813953488372]
