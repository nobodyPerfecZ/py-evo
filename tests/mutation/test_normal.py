...
from PyEvo.mutation.normal import GaussianMutation, LinearDecayGaussianMutation, EpsilonDecayGaussianMutation
...
class TestLinearDecayGaussianMutation(unittest.TestCase):
    """
    Tests the class LinearDecayGaussianMutation.
    """
    ...
    def setUp(self):
        ...
        self.optimizer_min = "min"
        self.optimizer_max = "max"
        self.mutator = LinearDecayGaussianMutation(mean=0.0, max_std=1.0, min_std=0.1, prob=1.0, steps=9)
...
class TestEpsilonDecayGaussianMutation(unittest.TestCase):
    """
    Tests the class EpsilonDecayGaussianMutation.
    """
    ...
    def setUp(self):
        ...
        self.optimizer_min = "min"
        self.optimizer_max = "max"
        self.mutator = EpsilonDecayGaussianMutation(mean=0.0, max_std=1.0, min_std=0.1, prob=1.0, steps=9)
